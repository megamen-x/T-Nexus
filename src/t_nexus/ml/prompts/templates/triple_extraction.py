from src.t_nexus.ml.prompts.templates.ner import one_shot_ner_paragraph, one_shot_ner_output
from src.t_nexus.ml.utils.llm import convert_format_to_template
